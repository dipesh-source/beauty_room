...
# from .helper import ServiceManager
from owner import delta
...
class Attendance(Common):
    ...
    check_out = models.BooleanField(default=True, null=True, blank=True)
